...
post_message(myToken,"#lotto", "라푼젤 당첨번호 :" + str(random.sample(range(1,46),7)))
post_message(myToken,"#lotto", "가가멜 당첨번호 :" + str(random.sample(range(1,46),7)))
post_message(myToken,"#lotto", "버즈 당첨번호 :" + str(random.sample(range(1,46),7)))
post_message(myToken,"#lotto", "쥬디 당첨번호 :" + str(random.sample(range(1,46),7)))
