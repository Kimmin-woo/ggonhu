...
while True:
    try:
        ...
        post_message(myToken,"#lotto", "$일확천금$ 로또 자동번호 생성 시작합니다.")
        post_message(myToken,"#lotto", "`축하합니다.`")
        post_message(myToken,"#lotto", "은진부장 당첨번호 : " + str(random.sample(range(1,46),7)))
        post_message(myToken,"#lotto", "상현부장 당첨번호 : " + str(random.sample(range(1,46),7)))
        post_message(myToken,"#lotto", "민우과장 당첨번호 : " + str(random.sample(range(1,46),7)))
        post_message(myToken,"#lotto", "효길부장 당첨번호 : " + str(random.sample(range(1,46),7)))
